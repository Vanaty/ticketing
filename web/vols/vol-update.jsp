        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<%= request.getContextPath()%>/vols/update" method="post">
                        <input type="hidden" name="vol.id" value="<%=vol.getId()%>">
                        <div class="form-group">
                            <label for="departureDate">Date de départ</label>
                            <input type="date" class="form-control" id="departureDate" name="vol.dtDepart" value="<%=vol.getDtDepart()%>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="departureTime" name="vol.heureDepart" value="<%=vol.getHeureDepart()%>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" value="00:00" class="form-control" id="duree" name="vol.duree" value="<%=vol.getDuree()%>" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="departureLocation" name="vol.idVilleDepart" required>
                                <% for(VilleDesservie a: villes){ %>
                                    <option value="<%= a.getId() %>" <%= (a.getId() == vol.getVilleDepart().getId()) ? "selected":"" %> ><%= a.getVille() %></option>
                                <% } %>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="destination" name="vol.idVilleArrive" required>
                                <% for(VilleDesservie a: villes){ %>
                                    <option value="<%= a.getId() %>" <%=(a.getId() == vol.getVilleArrive().getId()) ? "selected":"" %>><%= a.getVille() %></option>
                                <% } %>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="vol.idAvion" id="aircraft" class="form-control" required>
                                <% for(Avion a: avions){ %>
                                    <option value="<%= a.getId() %>" <%=(a.getId() == vol.getAvion().getId()) ? "selected":"" %>><%= a.getModele() %></option>
                                <% } %>
                            </select>
                        ...
                        <div class="form-row row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="0.0" name="prixs[]" id="aircraft" value="<%= vol.getPrixVol(a).getPrix() %>" class="form-control">
                            </div>
                            <% } %>
                        </div>
