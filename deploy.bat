...
set "work_dir=D:\S5\MrNaina\ticketing"
...
:: Vérifier si le dossier ressource existe et le copier
if exist "%work_dir%\ressource" (
    xcopy /s /i "%work_dir%\ressource\*" "%temp%\WEB-INF\classes"
)
...
if exist "%work_dir%\%war_name%.war" (
